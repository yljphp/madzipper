...
namespace Yljphp\Madzipper;

use Exception;
use Illuminate\Filesystem\Filesystem;
use Illuminate\Support\Str;
use Yljphp\Madzipper\Repositories\RepositoryInterface;
...
class Madzipper
{
    ...
    public function make($pathToFile, $type = 'zip'): self
    {
        ...
        $objectOrName = $type;
        if (is_string($type)) {
            $objectOrName = 'Yljphp\Madzipper\Repositories\\'.ucwords($type).'Repository';
        }

        if (! is_subclass_of($objectOrName, 'Yljphp\Madzipper\Repositories\RepositoryInterface')) {
