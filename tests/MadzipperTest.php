...
namespace Yljphp\Madzipper\Tests;

use Exception;
use Illuminate\Filesystem\Filesystem;
use InvalidArgumentException;
use Yljphp\Madzipper\Madzipper;
use Mockery;
...
{
    /**
     * @var \Yljphp\Madzipper\Madzipper
     */
    public $archive;
    ...
    {
        $this->assertSame('Yljphp\\Madzipper\\Tests\\ArrayArchive', $this->archive->getArchiveType());
